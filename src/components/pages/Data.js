...
export const homeObjOne = {
  ...
  description:
    "Get acces to uor exclusive diamond card thah allows you to send inlimited transactions whithout getting charged any fees",
    description2:
    "Nuri art es la artista mas exotica de cosquin transactions whithout getting charged any fees",
